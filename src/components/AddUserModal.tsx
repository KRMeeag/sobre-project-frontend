      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-162.5 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-8 pb-8 pt-4 flex justify-end">
          <button
            ...
            disabled={loading}
            className="flex items-center gap-2 bg-[#002f5a] hover:bg-[#001f3f] text-white font-medium py-3 px-6 rounded-lg transition-colors text-[14px] font-['Work_Sans'] focus:outline-none shadow-sm disabled:opacity-50"
          >
